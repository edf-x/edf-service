...
/**
 * Validates amount, integer and fraction.
 * <p/>
 * Supported types are:
 * <ul>
...
public @interface YJAmount {

    String message() default "{com.mk.common.validate.YJAmount.message}";
    ...
    /** default scale */
    int yjScale() default CommonConst.AMOUNT_DECIMAL_SCALE;
    ...
    /**
     * Defines several {@code @YJAmount} annotations on the same element.
     */
    @Target({ FIELD })
    @Retention(RUNTIME)
    @Documented
