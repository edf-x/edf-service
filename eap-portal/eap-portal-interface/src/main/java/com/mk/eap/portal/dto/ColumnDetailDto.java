...
public class ColumnDetailDto extends DTO{
	...
	EnumDetailDto fieldTypeDTO;
	Long width;  //宽度
	Long defPrecision; //默认精度
	Long idAlignType; //对齐方式
	EnumDetailDto alignTypeDTO;
	Long colIndex; //显示顺序
	Long idOrderMode; //排序方式
	EnumDetailDto orderModeDTO;
	Long isFixed; //是否固定列
	Long isVisible; //是否显示
	...
	public EnumDetailDto getFieldTypeDTO() {
		return fieldTypeDTO;
	}
	public void setFieldTypeDTO(EnumDetailDto fieldTypeDTO) {
	...
	public EnumDetailDto getAlignTypeDTO() {
		return alignTypeDTO;
	}
	public void setAlignTypeDTO(EnumDetailDto alignTypeDTO) {
		this.alignTypeDTO = alignTypeDTO;
	}
	...
	public EnumDetailDto getOrderModeDTO() {
		return orderModeDTO;
	}
	public void setOrderModeDTO(EnumDetailDto orderModeDTO) {
		this.orderModeDTO = orderModeDTO;
	}
